const cn = {
  ...
  commonUtils: {
    ...
    vmCondition: {
      networkExchangeFull: "宿主机网络资源已满（路由表/邻居表条目达到上限），暂时无法创建新的开发环境。请稍后重试，或联系管理员清理宿主机网络配置。",
      networkDeviceMissing: "开发环境网络设备初始化失败，暂时无法启动。请稍后重试，或联系管理员检查宿主机网络状态。",
      startupFailed: "开发环境启动失败，请稍后重试。若问题持续，请联系管理员并提供错误详情。",
    },
    file: {
      emptyList: "文件列表不能为空",
    },
